...
line_new: List[Any] = re.findall(r'[a-z]+', line)
print('C использованием re: ', line_new)

''' данный вид найден на просторах сети, но мной не понят'''
...
print('Без использованием модуля re: ', line_str_2)
